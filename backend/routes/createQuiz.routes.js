...
router.post('/', async function(req, res, next) {
    ...
    await db.query('INSERT INTO quizes (title, duration, image, categoryid, quiztypeid, authorid) VALUES ($1, $2, $3, $4, $5, $6)', [req.body.name, req.body.duration, req.body.image, categoryId.rows[0].id, quiztypeid.rows[0].id, author]);
